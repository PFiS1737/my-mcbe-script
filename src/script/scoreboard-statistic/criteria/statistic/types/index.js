...
export const types = {
    ...
    // mob
    "minecraft:killed": killed, killed,
    "minecraft:killed_by": killed_by, killed_by,
    "minecraft:killed_for": killed_for, killed_for,  // not in vanilla
    
    // block
    "minecraft:mined": mined, mined,
    "minecraft:placed": placed, placed,  // not in vanilla
