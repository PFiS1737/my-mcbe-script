 ...
 */
import { system, world, Dimension, ItemComponentTypes, BlockPermutation, BlockVolume, ItemStack, MinecraftDimensionTypes as MinecraftDimensionTypes$1, GameMode, EntityDamageCause, DisplaySlotId, ObjectiveSortOrder, Player } from '@minecraft/server';
...
class ItemStackWithDurability extends WrappedItemStack {
    ...
    constructor(itemStack){
        if (!ItemStackWithDurability.match(itemStack)) throw new TypeError(`The "${itemStack.typeId}" doesn't have the "${ItemComponentTypes.Durability}" component.`);
        super(itemStack);
    }
}
